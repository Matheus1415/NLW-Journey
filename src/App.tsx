...
import { MapPin, Calendar, ArrowRight, UserPlus, Settings2, X, AtSign, Plus, User } from 'lucide-react';
          ...
          <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
            <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
              ...
              <form onSubmit={addNewEmailToInvite} action="" className='w-full p-2.5 rounded-lg flex items-center gap-2 flex-col'>
                ...
                <button onClick={() => setIsComfirmTripModalOpen(false)} type='submit' className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 flex items-center gap-2 hover:bg-lime-400 w-full justify-center">
