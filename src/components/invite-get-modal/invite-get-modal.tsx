...
import { InviteGuestModalProps } from "../../interface/InviteGuestModalProps"

export const InviteGuestModal:React.FC<InviteGuestModalProps> = ({setIsGuestsModalOpen,removeEmailsFromInvide, emailsToInvide, addNewEmailToInvite}) => {
  return(
